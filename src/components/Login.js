...
const Login = () =>{
    ...
    return(
        <div >
            ...
            <form className="w-3/12 p-12 bg-black absolute my-36 mx-auto right-0 left-0 text-white bg-opacity-75">
                ...
                <p className="py-4 cursor-pointer" onClick={handleToggle}>{!isSignUp ? "New to Netflix? Sign up now" : "Already register, Login now"}</p>
            </form>
        </div>
    );
}
